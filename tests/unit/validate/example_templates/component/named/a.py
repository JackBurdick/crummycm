...
A_named_single = {"known_dict": NamedDict({"some_thing": ValuePlaceholder})}

A_named_double = {
    "known_dict": NamedDict({"a": ValuePlaceholder, "b": ValuePlaceholder})
}

A_named_outer_single = NamedDict({"some_thing": ValuePlaceholder})

A_named_outer_double = NamedDict({"a": ValuePlaceholder, "b": ValuePlaceholder})
